    ...
    def btn_calcular_on_click(self):
        ...
        if cantidad >= 6:
            ...
            if marca == 'ArgentinaLuz':
                precio = precio * cantidad * 0.6
            else:
                precio = precio * cantidad * 0.7
        
        elif cantidad == 4:
            if marca == 'ArgentinaLuz' or marca == 'FelipeLamparas':
                precio = precio * cantidad * 0.75
            else:
        ...
        if precio > 4000:
                ...
                precio -= descuento_adicional

        concate = 'Atencion, llevando ' + str(cantidad) + ' lámparas, el precio final es $' + str(precio)
        alert ('Precio final', concate)
